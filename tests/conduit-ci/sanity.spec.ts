...
// Sanity Tests
test('Get All Articles Test 1 @sanity', async ({ api, config}, testInfo) => {
    ...
    expect(response.status()).toBe(API_ERROR_CODES.FORBIDDEN);
...
test('Get All Articles Test 2 @sanity', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 3 @sanity', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 4 @sanity', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 5 @sanity', async ({ api, config}, testInfo) => {
