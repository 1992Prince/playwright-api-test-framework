...
// Regression Tests
test('Get All Articles Test 1 @regression1', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 2 @regression1', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 3 @regression1', async ({ api, config}, testInfo) => {
...
test('Get All Articles Test 4 @regression1', async ({ api, config}, testInfo) => {
